        ...
        <div className="headerSearchBar">
          ...
          <div className="SearchBarItem">
              ...
              {openCalendar && <DateRange 
                                ...
                                onChange = {item => setDates([item.selection])} //onChange把紀錄到的改動都紀錄到state date 裡面我們暫存器就會有選好的日期範圍，等於是輸入到暫存器；item.selection的概念就是讓他選擇上傳到key=selection的部分
                                ...
                                minDate = {new Date()}
                                locale = {locales['zhTW']} //最後這邊就是語言版本使用繁體中文zhTW概念 ；就可以用到上面的import * as locales from 'react-date-range/dist/locale'
              />}
          </div>
          <div className="SearchBarItem">
